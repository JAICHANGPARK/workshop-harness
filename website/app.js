...
const I18N_DICT = {
  en: {
    ...
    hero_title: 'One-Click <span class="gradient-text">AI Agent Harness</span> &amp; 13 Skill Suite',
  ...
  ko: {
    ...
    hero_title: '원클릭 <span class="gradient-text">AI Agent Harness</span> &amp; 13 Skill Suite',
  ...
  ja: {
    ...
    hero_title: 'ワンクリック <span class="gradient-text">AI Agent Harness</span> &amp; 13 Skill Suite',
  ...
  zh: {
    ...
    hero_title: '一键式 <span class="gradient-text">AI Agent Harness</span> &amp; 13项技能套件',
