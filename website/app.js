...
const I18N_DICT = {
  en: {
    ...
    nav_skills: '15 Skills',
    nav_codelabs: 'Open Codelabs',
    nav_arch: 'Arch Matrix',
    nav_gen: 'CLI Generator',
    nav_docs: 'Docs',
    hero_title: 'One-Click AI Agent Harness &amp; 15 Skill Suite',
    ...
    f2_title: '15 Agent Skills Suite',
    ...
    skills_title: '15 Agent Skills Explorer',
    skills_desc: 'Explore specifications and artifacts for all 15 native AI agent skills.',
    f_all: 'All (15)',
  ...
  ko: {
    ...
    nav_gen: 'CLI 생성기',
    nav_docs: '공식 문서',
    hero_title: '원클릭 AI Agent Harness &amp; 15 Skill Suite',
    ...
    f2_title: '15개 에이전트 스킬',
    f2_desc: '아키텍처 호환성 검사, 런북 작성, 현장 라이브 핫픽스, Open Codelabs 연동 등 검증된 15개 에이전트 스킬을 탑재했습니다.',
    f3_title: '크로스 아키텍처 호환',
    f3_desc: 'Apple Silicon, Intel Mac, Windows x64/ARM64, Linux 환경의 호환성 리스크를 오디팅하고 Fallback 경로를 자동 구성합니다.',
    skills_title: '15개 에이전트 스킬 탐색기',
    skills_desc: '필터와 검색을 통해 Workshop Harness의 15개 네이티브 에이전트 스킬 명세서를 탐색해보세요.',
    f_all: '전체 (15)',
    f_core: '커리큘럼 &amp; 작성',
    f_audit: '검증 &amp; 호환성',
  ...
  ja: {
    ...
    skills_title: '15エージェントスキル・エクスプローラー',
    skills_desc: '15のネイティブAIエージェントスキルの仕様と成果物を探索できます。',
    f_all: 'すべて (15)',
    f_core: 'カリキュラム &amp; 作成',
    f_audit: '検証 &amp; 互換性',
  ...
  zh: {
    ...
    nav_gen: 'CLI生成器',
    nav_docs: '官方文档',
    hero_title: '一键式 AI Agent Harness &amp; 15项技能套件',
    ...
    skills_title: '15 项 Agent 技能浏览器',
    skills_desc: '探索 15 项原生 AI Agent 技能的规范与产物。',
    f_all: '全部 (15)',
    f_core: '课程与撰写',
    f_audit: '审计与测试',
    f_platform: '平台与 PDF',
