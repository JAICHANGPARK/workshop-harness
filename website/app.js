...
const I18N_DICT = {
  en: {
    ...
    nav_skills: '17 Skills',
    nav_codelabs: 'Open Codelabs',
    nav_arch: 'Arch Matrix',
    nav_gen: 'CLI Generator',
    nav_docs: 'Docs',
    hero_title: 'One-Click AI Agent Harness &amp; 17 Skill Suite',
    ...
    f2_title: '17 Agent Skills Suite',
    f2_desc: 'Includes cross-architecture auditing, ADK multi-agent builder, ELI5 concept explainer, runbook generation, live hotfixes, persona loops, and Open Codelabs integration.',
    ...
    skills_title: '17 Agent Skills Explorer',
    skills_desc: 'Explore specifications and artifacts for all 17 native AI agent skills.',
    f_all: 'All (17)',
  ...
  ko: {
    ...
    nav_gen: 'CLI 생성기',
    nav_docs: '공식 문서',
    hero_title: '원클릭 AI Agent Harness &amp; 17 Skill Suite',
    ...
    f2_title: '17개 에이전트 스킬',
    f2_desc: '아키텍처 호환성 검사, ADK 멀티 에이전트 빌더, ELI5 개념 설명기, 런북 작성, 현장 라이브 핫픽스, Open Codelabs 연동 등 검증된 17개 에이전트 스킬을 탑재했습니다.',
    f3_title: '크로스 아키텍처 호환',
    f3_desc: 'Apple Silicon, Intel Mac, Windows x64/ARM64, Linux 환경의 호환성 리스크를 오디팅하고 Fallback 경로를 자동 구성합니다.',
    skills_title: '17개 에이전트 스킬 탐색기',
    skills_desc: '필터와 검색을 통해 Workshop Harness의 17개 네이티브 에이전트 스킬 명세서를 탐색해보세요.',
    f_all: '전체 (17)',
    f_core: '커리큘럼 &amp; 작성',
    f_audit: '검증 &amp; 호환성',
    ...
    s3_desc: 'oc mcp serve로 AI 에이전트가 실시간 대화식으로 코드랩 및 질문 queue 조율',
  ...
  ja: {
    ...
    f2_title: '17のエージェントスキル',
    f2_desc: 'アーキテクチャ診断、ADKマルチエージェントビルダー、ELI5概念説明、ランブック作成、ライブ障害対応、Open Codelabs連携など検証済みスキルを搭載。',
    f3_title: 'クロスアーキテクチャ対応',
    f3_desc: 'Apple Silicon、Intel Mac、Windows、Linuxにおける互換性リスクを診断しFallbackを提供。',
    skills_title: '17エージェントスキル・エクスプローラー',
    skills_desc: '17のネイティブAIエージェントスキルの仕様と成果物を探索できます。',
    f_all: 'すべて (17)',
    f_core: 'カリキュラム &amp; 作成',
    f_audit: '検証 &amp; 互換性',
  ...
  zh: {
    ...
    nav_gen: 'CLI生成器',
    nav_docs: '官方文档',
    hero_title: '一键式 AI Agent Harness &amp; 17项技能套件',
    ...
    f2_title: '17 项 Agent 技能套件',
    f2_desc: '包含跨架构审计、ADK 多 Agent 构建、ELI5 概念解释器、Runbook 生成、现场热修复、Persona 循环审查及 Open Codelabs 集成。',
    f3_title: '跨架构引擎',
    f3_desc: '审计 Apple Silicon、Intel Mac、Windows x64/ARM64 及 Linux 上的硬件风险并提供 Fallback 方案。',
    skills_title: '17 项 Agent 技能浏览器',
    skills_desc: '探索 17 项原生 AI Agent 技能的规范与产物。',
    f_all: '全部 (17)',
    f_core: '课程与撰写',
    f_audit: '审计与测试',
    f_platform: '平台与 PDF',
...
const SKILLS_DATA = [
  ...
  {
    num: "16",
    id: "adk-workshop-builder",
    title: "adk-workshop-builder",
    cat: "core",
    desc: "Builds multi-language (Python, TypeScript, Go, Kotlin) ADK autonomous agent and multi-agent system labs",
    input: "ADK workshop topic & stack",
    output: "Multi-agent coordinator & sub-agent lab scaffolds"
  },
  {
    num: "17",
    id: "eli5-concept-explainer",
    title: "eli5-concept-explainer",
    cat: "core",
    desc: "Translates complex AI mechanics and errors into 3-tier ELI5 physical analogies & mental maps",
    input: "Technical concept or error",
    output: "docs/eli5-concept-cheat-sheet.md, analogy cards"
  }
];
