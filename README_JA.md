...
**`workshop-harness`** は、**Build with AI (BWAI)**、DevFest、コミュニティハンズオンなどを準備する主催者、発表者、TAのための**AIエージェントハーネス＆スキル（Skills）集およびCLI自動化ツールキット**です。

---

## 💡 全9種類のエージェントスキル仕様（Skill Specification）
