...
This installs all 17 skill directories into `~/.gemini/skills/` so **Google Antigravity** and **Gemini CLI** natively detect them.
...
- **Native Skill Discovery**: All 17 skills in `~/.gemini/skills/` are automatically available.
