...
> **AI Agent Harness, 17 Skill Suite & CLI Automation Toolkit** for Technical Workshops (Build with AI, DevFest, Hands-on Labs)
...
# 2. Auto-install 17 skills to local agent environment (~/.gemini/skills)
