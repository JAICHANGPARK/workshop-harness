...
| 12 | `workshop-persona-loop-evaluator` | Topic & materials | Multi-persona loop engineering audit for beginner, intermediate, and advanced attendees | [`skills/workshop-persona-loop-evaluator/SKILL.md`](file:///Users/jaichang/Documents/GitHub/workshop-harness/skills/workshop-persona-loop-evaluator/SKILL.md) |
